...
const timelineEvents = [
  {
    day: "Day 1",
    date: "March 15, 2025",
    title: "Opening Ceremony & Prelims",
    description: "Grand inauguration with cultural performances, followed by preliminary rounds across all categories.",
    icon: Sun,
    highlights: ["Opening ceremony", "Band auditions", "Dance prelims", "Art exhibition opens"],
  },
  {
    day: "Day 2",
    date: "March 16, 2025",
    title: "Main Events & Semi-Finals",
    description: "The competition intensifies as participants battle it out in semi-final rounds and main events.",
    icon: Stars,
    highlights: ["Semi-final rounds", "Theatre performances", "Photography contest", "Gaming tournaments"],
  },
  {
    day: "Day 3",
    date: "March 17, 2025",
    title: "Finals & Closing Ceremony",
    description: "The grand finale featuring final showdowns, prize distribution, and star-studded performances.",
    icon: Moon,
    highlights: ["Grand finale events", "Celebrity performances", "Prize distribution", "Closing ceremony"],
  },
];
